        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 flex flex-col justify-between">
            <div>
              ...
              >
                <span className="inline-flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg border border-primary/25 bg-primary/8 shadow-[0_0_26px_rgba(124,92,255,0.18)]">
                  <Image
            ...
            <div className="flex items-center gap-3 mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] border border-transparent hover:border-[var(--color-border-hover)] transition-all duration-150"
                aria-label="GitHub"
              >
                <svg
                  width="16"
          ...
          {/* Link columns */}
          <div className="md:col-span-3 grid grid-cols-2 gap-8 md:max-w-md md:ml-auto">
      ...
      <div className="border-t border-[var(--color-border)]">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12 py-5 md:py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-[12px] text-[var(--color-text-muted)]">
            ...
            <span
              className="hidden sm:inline text-[var(--color-text-muted-foreground)]"
              aria-hidden="true"
            >
              |
            </span>
