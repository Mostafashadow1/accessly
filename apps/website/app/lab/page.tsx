    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24">
      ...
      <div className="relative text-center max-w-3xl mx-auto mb-10 pt-20 pb-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-base md:text-lg text-muted leading-relaxed max-w-[480px] mx-auto text-balance">
            Test custom permission mappers, configure roles, and simulate frontend conditional gating in real-time before installing.
          </p>

          {/* Preset selectors - styled as toggle pills */}
          <div className="flex flex-wrap justify-center gap-2 mt-8">
            <span className="text-xs font-semibold text-muted self-center mr-2 uppercase tracking-[0.08em]">Presets:</span>
            {(Object.keys(presets) as PresetKey[]).map((key) => (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-lg text-xs font-medium border transition-all cursor-pointer ${
                  activePreset === key
                    ? "bg-primary-light text-accent border-primary"
                    : "bg-surface text-muted border-border hover:text-foreground hover:border-white/15"
                }`}
              >
